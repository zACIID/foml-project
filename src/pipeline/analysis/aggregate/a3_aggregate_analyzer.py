...
class A3AggregatePlotTypes(enum.Enum):
...
class A3AggregateAnalyzer(AggregateAnalyzer[A3AggregatePlotTypes]):
    """
    Aggregate analyzer for FoAI's 3rd Assignment
    """

    def analyze(self, evaluations: Sequence[ModelEvaluation]) -> AggregateAnalysis[A3AggregatePlotTypes]:
        ...
        return AggregateAnalysis(
            plots={
                # Training times
                A3AggregatePlotTypes.GMM_TRAINING_TIMES_BY_DIM: _training_times_plot(gmm_evals_df),
                A3AggregatePlotTypes.MEAN_SHIFT_TRAINING_TIMES_BY_DIM: _training_times_plot(ms_evals_df),
                A3AggregatePlotTypes.NCUT_TRAINING_TIMES_BY_DIM: _training_times_plot(ncut_evals_df),
                A3AggregatePlotTypes.ALL_MODEL_TRAINING_TIMES_BY_DIM: _training_times_plot(combined_df),

                # Rand Index
                A3AggregatePlotTypes.GMM_RAND_INDEX_BY_DIM: _rand_idx_plot(gmm_evals_df),
                A3AggregatePlotTypes.MEAN_SHIFT_RAND_INDEX_BY_DIM: _rand_idx_plot(ms_evals_df),
                A3AggregatePlotTypes.NCUT_RAND_INDEX_BY_DIM: _rand_idx_plot(ncut_evals_df),
                A3AggregatePlotTypes.ALL_MODEL_RAND_INDEX_BY_DIM: _rand_idx_plot(combined_df),

                # N clusters
                A3AggregatePlotTypes.GMM_N_CLUSTERS_BY_DIM: _n_clusters_plot(gmm_evals_df),
                A3AggregatePlotTypes.NCUT_N_CLUSTERS_BY_DIM: _n_clusters_plot(ncut_evals_df),
                A3AggregatePlotTypes.MEAN_SHIFT_N_CLUSTERS_BY_DIM: _n_clusters_plot(ms_evals_df),
                A3AggregatePlotTypes.ALL_N_CLUSTERS_BY_DIM: _n_clusters_plot(combined_df),
            },
